...
elec.electron_launcher('google-calendar.desktop', 'Google Calendar', 'https://calendar.google.com', 'google-calendar', "A time-management and scheduling calendar service developed by Google.", categories=['Network', 'Office'], all_urls=False, dark=False, flags="--internal-urls '.*?\.google\.*?|.*?auth\.berkeley\.*?' --tray --single-instance --app-version '0.6' --inject 'resources/calendar.css'", styles=['calendar2'], force_style=True, notifications=True)
