...
elec.electron_launcher('google-mail.desktop', 'Gmail', 'https://mail.google.com', 'gmail', "Email that's intuitive, efficient, and useful.", categories=['Network', 'Email', 'Office', 'InstantMessaging'], all_urls=False, dark=True, flags="--counter --internal-urls '.*?\.google\.*?|.*?auth\.berkeley\.*?' --tray --single-instance", styles=['gmail', 'bauth', 'gauth'], force_style=True, notifications=True)
# elec.electron_launcher('google-mail.desktop', 'Gmail', 'https://mail.google.com', 'gmail', "Email that's intuitive, efficient, and useful.", categories=['Network', 'Email', 'Office', 'InstantMessaging'], all_urls=False, dark=True, flags="--counter --internal-urls '.*?\.google\.*?' --tray --single-instance", styles=['gmail', 'bauth', 'gauth'], force_style=True, notifications=True)
elec.electron_launcher('google-calendar.desktop', 'Google Calendar', 'https://calendar.google.com', 'google-calendar', "A time-management and scheduling calendar service developed by Google.", categories=['Network', 'Office'], all_urls=False, dark=True, flags="--counter --internal-urls '.*?\.google\.*?|.*?auth\.berkeley\.*?' --tray --single-instance", styles=['calendar'], force_style=True, notifications=True)
elec.electron_launcher('google-messages.desktop', 'Messages', 'https://messages.google.com/web', 'internet-chat', "Simple, helpful messaging by Google.", categories=['Network', 'InstantMessaging'], all_urls=True, dark=False, flags="--counter --tray --single-instance", notifications=True)
