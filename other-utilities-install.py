...
# elec.electron_launcher('acrobat.desktop', 'Acrobat', 'https://documentcloud.adobe.com/', 'acroread', 'Adobe Acrobat online.', categories=['Productivity', 'Office', 'Utility'], dark=False, flags='--inject "resources/default.css"')
elec.electron_launcher('acrobat.desktop', 'Acrobat', 'https://documentcloud.adobe.com/', 'acroread', 'Adobe Acrobat online.', categories=['Productivity', 'Office', 'Utility'], dark=False)